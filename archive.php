  ...
  <div id="intro">
   ...
   <div id="kk"><div id="arrow">&#x25BC;</div><ul id="categories">
    ...
    <?php if (have_posts()) : ?>  
      ...
      <?php if (is_category()) { ?>       
        <h3 class="archive-for"><?php _e('Archive for '); echo single_cat_title(); ?></h3>

      <?php } elseif (is_day()) { ?>
        <h3 class="archive-for"><?php _e('Archive for '); the_time('F j, Y'); ?></h3>


      <?php } elseif (is_month()) { ?>
        <h3 class="archive-for"><?php _e('Archive for '); the_time('F, Y'); ?></h3>

      <?php } elseif (is_year()) { ?>
        <h3 class="archive-for"><?php _e('Archive for '); the_time('Y'); ?></h2>

      <?php } elseif (is_author()) { ?>
        <h3 class="archive-for"><?php _e('Author Archive'); ?></h3>

      <?php } elseif (is_search()) { ?>
        <h3 class="archive-for"><?php _e('Search Results'); ?></h3>
